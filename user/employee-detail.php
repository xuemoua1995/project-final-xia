          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4>ລາຍລະອຽດຂໍ້ມູນພະນັກງານ</h4>
              </div>
             
              <div class="container-fluid">
              <a href="employee.php" type="button" style="font-size:15px" class="btn btn-primary" ><i class='fas fa-backward'></i> ກັບຄືນ</a>
              <?php
               ...
               <a href='employee.php'>View Updated Record</a>";
		    ...
		    <form method="POST" action="employee-edit.php" style="font-size: 15px;">
						...
						<div class="col-12 mb-3">
                                   ...
                                   <input type="date" name="birthday" value="<?php echo $row['birthday'];?>" class="form-control" disabled />
							<div class="invalid-feedback" style="font-size:15px">
						...
						<div class="col-12 mb-3">
                                   <p>ເພດ</p>
                                   <input type="radio" name="gender" disabled value="ຍິງ" <?php if($result['gender']=="ຍິງ"){ echo "checked";}?>/> ຍິງ
                                   <input type="radio" name="gender" disabled value="ຊາຍ" <?php if($result['gender']=="ຊາຍ"){ echo "checked";}?> /> ຊາຍ
                              </div>
						<div class="col-12 mb-3">
						...
						<div class="col-12 mb-3">
                                   ...
                                   <input type="text" name="phone" value="<?php echo $row['phone'];?>" class="form-control" disabled />
							<div class="invalid-feedback" style="font-size:15px">
							ກະລຸນາປ້ອນເບີໂທ
							</div>
                              </div>
