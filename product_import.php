...
<div class="main-content">
    <section class="section">
      <div class="section-body">   
        <div class="row">
          <div class="col-12">
          <a href="#addnewproductimport" class="btn btn-success" data-toggle="modal" style="font-size:15px"><i class="fas fa-edit"></i> ເພີ່ມຂໍ້ມູນສັ່ງຊື້ສິນຄ້າ</a>
            <div class="card">
              <div class="card-header">
                <h4>ຂໍ້ມູນສັ່ງຊື້ສິນຄ້າເຂົ້າຮ້ານ</h4>
                    ...
                    $count = 1;
                      ...
                      $query = $conn->query($sql);
                        ...
                        while($row =  $query->fetch_assoc()) {?>
                          ...
                          <td>
                            <a href="product-edit-import.php?id=<?php echo $row["id"]; ?>" class='btn btn-primary' style='font-size:15px'><i class='fas fa-edit'></i> ແກ້ໄຂ</a> 
...
<?php include('product-add-import.php') ?>
<?php 
