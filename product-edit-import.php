          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4>ແກ້ໄຂຂໍ້ມູນສັ່ງຊື້ສິນຄ້າ</h4>
              </div>
              ...
              $typename  = mysqli_query($conn, "SELECT DISTINCT typename FROM tb_ProductType");
               ...
               <a href='product_import.php' class='btn btn-primary'>ກັບໄປເບິ່ງຂໍ້ມູນທີ່ແກ້ໄຂແລ້ວ</a>";
		    ...
		    <form method="POST" action="product-edit.php" style="font-size: 15px;">
				...
				<a href="product_import.php" type="button" style="font-size:15px" class="btn btn-danger" ><span class="glyphicon glyphicon-remove"></span> ຍົກເລີກ</a>
